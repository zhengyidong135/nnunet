...
if __name__ == '__main__':
    ...
    predictor.initialize_from_trained_model_folder(
        join(nnUNet_results, 'Dataset004_example/nnUNetTrainer__nnUNetPlans__3d_fullres'),
        use_folds=(0,1,2,3),
        checkpoint_name='checkpoint_best.pth',
    )
    predictor.predict_from_files(join(nnUNet_raw, '/home/cqc/下载/Xunqi/my_nnunet/DATASET/nnUNet_raw/Dataset004_example/imagesTs/images-nii-2'),
                                 join(nnUNet_raw, '/home/cqc/下载/Xunqi/my_nnunet/DATASET/nnUNet_raw/Dataset004_example/labelsTs'),
    ...
    img, props = SimpleITKIO().read_images([join(nnUNet_raw, 'Dataset004_example/imagesTr/case_00001_0000.nii.gz')])
