...
if __name__ == '__main__':
    ...
    predictor.initialize_from_trained_model_folder(
        join(nnUNet_results, '/media/dell/T7 Shield/模型的更迭/HBP/2025-12-01/livertumor_HBP_001_12_01/nnUNetTrainer__nnUNetPlans__3d_fullres'),
        use_folds=(1,0,2,3,4),
        checkpoint_name='checkpoint_best.pth',
    )
    predictor.predict_from_files(join('/media/dell/T7 Shield1/nnunet/AllData/GXZL/finished/HBP/nii/Group5'),
                                 join('/media/dell/T7 Shield1/nnunet/AllData/GXZL/finished/HBP/pre/prelivrtumor/Group5'),
    ...
    img, props = SimpleITKIO().read_images([join(nnUNet_raw, 'Dataset006_example/imagesTr/case_00001_0000.nii.gz')])
